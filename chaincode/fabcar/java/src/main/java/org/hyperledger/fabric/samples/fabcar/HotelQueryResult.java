 ...
 */
@DataType()
public final class HotelQueryResult {
    @Property()
    private final String key;

    @Property()
    private final Hotel record;

    public HotelQueryResult(@JsonProperty("Key") final String key, @JsonProperty("Record") final Hotel record) {
        this.key = key;
        this.record = record;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        HotelQueryResult other = (HotelQueryResult) obj;
